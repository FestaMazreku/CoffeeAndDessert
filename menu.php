...
<head>
  ...
  <br> 
        ...
        $stmt = $connect->prepare("SELECT * FROM menu");
        $stmt->execute();
        ...
        <div class="menu">
          <div class="single-menu">
           <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
            <img src="<?= $row['fotografia']?>" alt=""><br>
             <h4 class="h1"><b><?= $row['emri']?></b>
              <span><?= number_format($row['cmimi'],2)?>$</span></h4>
              <p class="pp"><?= $row['pershkrimi']?></p>
             </div>
          </div>
        </div>
      </center>
